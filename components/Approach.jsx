  ...
  <section className="w-full py-20">
    ...
    <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
            ...
            description="We'll work together to outline your website's objectives, identify your target audience, and determine essential features. We'll cover aspects like site organization, navigation, and content needs."
        >
        ...
        <Card 
            ...
            description="When the plan is established, I dive straight into coding. I’ll make sure to update you at every stage, from early drafts to the completed project."
        >
            <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
            ...
            description="This is the phase where it all comes together! Using the approved design, I’ll develop functional code to build your website from the ground up."
        >
            <CanvasRevealEffect
            animationSpeed={3}
